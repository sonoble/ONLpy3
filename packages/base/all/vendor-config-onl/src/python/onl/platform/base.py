...
class OnlPlatformPortConfig_48x1_4x25(object):
    PORT_COUNT=52
    PORT_CONFIG="48x1 + 4x25"
...
class OnlPlatformPortConfig_64x200(object):
    PORT_COUNT=64
    PORT_CONFIG="64x200"
...
class OnlPlatformPortConfig_32x400_2x10(object):
    PORT_COUNT=34
    PORT_CONFIG="32x400 + 2x10"
...
class OnlPlatformPortConfig_4x400_22x100_4x25(object):
    PORT_COUNT=30
    PORT_CONFIG="4x400 + 22x100 + 4x25"

class OnlPlatformPortConfig_2x400_8x100_64x25(object):
    PORT_COUNT=74
    PORT_CONFIG="2x400 + 8x100 + 64x25"
